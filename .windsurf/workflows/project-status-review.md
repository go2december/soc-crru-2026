...
3. Review `docs/WORKFLOW-chiang-rai-admin.md` and `docs/WORKFLOW-faculty-admin.md` for operational notes that no longer match the implementation.
4. Review `docs/PLAN-workflow-standardization.md` to ensure the documentation structure still reflects the repository.
5. Check that `.windsurf/workflows/` contains the required executable workflows and that their steps still match current implementation behavior.
