...
- stay aligned with `.windsurfrules` and team-facing references in `README.md`
...
- `.windsurf/workflows/chiang-rai-admin.md`
  - CRUD/admin work for Chiang Rai Studies

- `.windsurf/workflows/content-population.md`
  - adding or revising real content across public pages and admin-managed sections

- `.windsurf/workflows/release-checklist.md`
...
- `.windsurf/workflows/faculty-admin.md`
  - CRUD/admin work for the Faculty admin area

- `.windsurf/workflows/local-deployment.md`
...
- update the matching `.windsurf/workflows/*.md` only if execution steps changed

### If a new operational process is introduced
- document the human-readable process in `docs/WORKFLOW-*.md`
- add or update an executable workflow in `.windsurf/workflows/`
...
- Established `.windsurf/workflows/` as the executable workflow area
- Established `.windsurf/skills/` as the local project skill area
...
- Added a team-facing local skill map reference path across `.windsurfrules`, `README.md`, and `docs/WORKFLOW-project-status.md`
