...
This document defines how workflow, plan, and status artifacts must be organized for the SOC-CRRU Web Application so that written documentation in `docs/` stays aligned with executable workflows in `.agent/workflows/`.
...
## 🗂️ บทบาทของเอกสาร (Artifact Roles)
...
## 🏷️ รูปแบบสถานะมาตรฐาน (Status Taxonomy)
...
## ✅ งานที่ดำเนินการแล้ว ณ March 23, 2026 (Immediate Actions Completed)
