...
const SERVICES = [
    { name: 'ระบบทะเบียน (REG)', desc: 'ลงทะเบียนเรียน ตรวจสอบผลการเรียน', url: 'https://reg.crru.ac.th', icon: '📝', color: 'bg-blue-100 text-blue-600' },
    { name: 'CRRU LMS', desc: 'ระบบจัดการเรียนการสอนออนไลน์', url: 'https://lms.crru.ac.th', icon: '💻', color: 'bg-orange-100 text-orange-600' },
    { name: 'ระบบจองห้องสมุด', desc: 'จองห้องค้นคว้าและยืมคืนหนังสือ', url: '#', icon: '📚', color: 'bg-green-100 text-green-600' },
    { name: 'ระบบกู้ยืม (กยศ.)', desc: 'กองทุนเงินให้กู้ยืมเพื่อการศึกษา', url: '#', icon: '💰', color: 'bg-yellow-100 text-yellow-600' },
    { name: 'ระบบกิจกรรม (Activity)', desc: 'บันทึกและตรวจสอบชั่วโมงกิจกรรม', url: '#', icon: 'r', color: 'bg-rose-100 text-rose-600' },
    ...
    return (
        <main className="min-h-screen bg-base-100 text-base-content pb-20">
            <section className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16 px-4 text-center">
                <h1 className="text-4xl font-bold mb-4 font-heading">บริการสำหรับนักศึกษา</h1>
                <p className="text-xl opacity-90">Student E-Services</p>
            </section>
