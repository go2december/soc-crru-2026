...
const programData: ProgramData = {
    ...
    description: "เน้นการแลกเปลี่ยนเรียนรู้ภาคปฏิบัติเพื่อเปลี่ยนความรู้ให้เป็นพลังในการพัฒนาสังคม มุ่งสร้างบัณฑิตที่เป็น 'นวัตกรสังคม' ที่สามารถขับเคลื่อนการเปลี่ยนแปลงผ่านการลงมือทำจริง โดยบูรณาการศาสตร์การพัฒนาชุมชนเข้ากับเทคโนโลยีสมัยใหม่และการจัดการธุรกิจเพื่อสังคม (Social Enterprise) เพื่อให้บัณฑิตสามารถทำงานได้ทั้งในภาครัฐ ภาคเอกชน และองค์กรพัฒนาเอกชน (NGOs) ได้อย่างมีประสิทธิภาพ",
    highlights: [
        {
