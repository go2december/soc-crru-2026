...
const programData: ProgramData = {
    ...
    description: "สานต่อภูมิปัญญาด้วยดีไซน์ที่ทันสมัย หลักสูตรนี้มุ่งเน้นการพัฒนางานศิลปประดิษฐ์ งานดอกไม้ และงานสิ่งทอ ให้เป็นผลิตภัณฑ์ไลฟ์สไตล์ที่มีมูลค่าสูง ผู้เรียนจะได้เรียนรู้กระบวนการออกแบบ (Design Thinking) การเลือกใช้วัสดุ และการตลาดดิจิทัล เพื่อยกระดับงานฝีมือท้องถิ่นสู่ตลาดสากล พร้อมรองรับธุรกิจไมซ์ (MICE) และงานอีเวนต์ครบวงจร",
    highlights: [
        {
