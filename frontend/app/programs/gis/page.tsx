...
const programData: ProgramData = {
    ...
    description: "บูรณาการทฤษฎีภูมิศาสตร์กับเทคโนโลยีสมัยใหม่ เช่น GIS, Remote Sensing และเทคโนโลยีอากาศยานไร้คนขับ (UAV) เพื่อวิเคราะห์และแก้ไขปัญหาเชิงพื้นที่อย่างเป็นระบบ หลักสูตรนี้มุ่งเน้นการสร้างบัณฑิตที่มีทักษะปฏิบัติจริง (Hands-on) สามารถประยุกต์ใช้ข้อมูลภูมิสารสนเทศในการจัดการภัยพิบัติ การวางผังเมือง และการจัดการทรัพยากรธรรมชาติได้อย่างมีประสิทธิภาพ",
    highlights: [
        {
