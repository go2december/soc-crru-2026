        ...
        <div className="space-y-6 font-kanit">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm border border-stone-200 p-6 space-y-4">
                    ...
                    <ReactQuill theme="snow" value={formData.content} onChange={(content) => setFormData(prev => ({ ...prev, content }))} modules={quillModules} formats={quillFormats} className="bg-white" placeholder="เนื้อหาเกี่ยวกับแหล่งเรียนรู้..." />
                </div>
