...
export default function EditActivityPage() {
    ...
    const fetchActivity = async () => {
        try {
            const res = await fetch(`${API_URL}/api/chiang-rai/activities/by-id/${activityId}`);
            if (res.ok) {
                const data = await res.json();
                ...
                setFormData({
                    ...
                    eventDate: formatDatetimeLocal(data.eventDate),
                    eventEndDate: formatDatetimeLocal(data.eventEndDate),
                    tags: data.tags || [],
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`${API_URL}/api/chiang-rai/activities/${activityId}`, {
                method: 'PUT',
    ...
    return (
        <div className="space-y-6 font-kanit">
            <div className="flex items-center gap-4 border-b border-stone-200 pb-4">
                ...
                <div>
                    <h1 className="text-xl font-bold text-stone-800">แก้ไขกิจกรรม/ข่าวสาร</h1>
                    <p className="text-xs text-stone-500">Edit Activity / News</p>
                </div>
            </div>
