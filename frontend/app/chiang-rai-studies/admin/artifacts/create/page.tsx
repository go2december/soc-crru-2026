...
export default function CreateArtifactPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await fetch(`${API_URL}/api/chiang-rai/artifacts`, {
                method: 'POST',
    ...
    return (
        <div className="space-y-6 font-kanit">
            <div className="flex items-center gap-4 border-b border-stone-200 pb-4">
                ...
                <div>
                    <h1 className="text-xl font-bold text-stone-800">เพิ่มรายการใหม่</h1>
                    <p className="text-xs text-stone-500">Create New Artifact</p>
                </div>
            </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="ชื่อข้อมูลอัตลักษณ์"
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className="w-full px-4 py-2.5 rounded-lg border border-stone-200 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                placeholder="อธิบายสั้นๆ เกี่ยวกับข้อมูลนี้"
                            />
                        </div>
                    </div>
                </div>
