                        ...
                        <div className="pt-4 space-y-2 text-sm">
                            ...
                            <p className="flex items-start gap-2">
                                ...
                                <span className="flex flex-col">
                                    <a href="tel:053776000,1211" className="hover:text-white transition-colors">053-776-000 ต่อ 1211</a>
                                    <a href="tel:053702870" className="hover:text-white transition-colors">053-702-870</a>
                                </span>
                            </p>
