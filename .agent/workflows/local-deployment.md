...
7. Run the release readiness review alongside `.windsurf/workflows/release-checklist.md` (or `.agent/workflows/release-checklist.md`) when preparing for a broader verification pass.
